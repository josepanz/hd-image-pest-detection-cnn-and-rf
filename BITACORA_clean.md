...
````python
def main():
  parser = argparse.ArgumentParser(description="Entrena el modelo HD-only para deteccin de plagas")
  parser.add_argument("data_dir", help="Directorio raz con subcarpetas de clases")
  parser.add_argument("-e", "--epochs", type=int, default=20, help="Nmero mximo de pocas")
  ...
  parser.add_argument("-t", "--threshold", type=float, default=0.5, help="Umbral de decisin (0.0 a 1.0)")
...
--- [T=0.07s] ---
2. Filtrado y extraccin de datos

--- [Fecha/hora inicio=20260324_1236] ---

--- [T=0.08s] ---
2.1. Iniciando procesamiento de 665 imgenes etiquetadas...
...
--- ANLISIS DE UMBRAL PTIMO ---
Mejor Umbral detectado: 0.5214

Nueva Matriz de Confusin con Umbral ptimo:
[[267  93]
 [ 15 157]]
...
Imagen invlida: 4 canales (esperado 3)
Imagen invlida: 4 canales (esperado 3)
Imagen invlida: 4 canales (esperado 3)
Imagen invlida: 4 canales (esperado 3)
Imagen invlida: 4 canales (esperado 3)
...
````python
def main():
  parser = argparse.ArgumentParser(description="Entrena el modelo RGB o MULTIESPECTRAL para deteccin de plagas")
  parser.add_argument("data_dir", help="Directorio raz con subcarpetas de clases")
  parser.add_argument("-e", "--epochs", type=int, default=20, help="Nmero mximo de pocas")
  parser.add_argument("-a", "--alpha", type=float, default=0.50, help="Alpha")
  parser.add_argument("-g", "--gamma", type=float, default=3.0, help="Gamma")
...
Modelo Random Forest con extraccin CNN
...
--- [T=109.65s] ---
2. Cargando modelo CNN para extraccin de features...
...
## II. EVALUACION
### - El algoritmo de evaluacin, `evaluate.py`, permite los siguientes argumentos:
````python
if __name__ == "__main__":
  parser = argparse.ArgumentParser(description="Evala el modelo CNN con BCE/Focal RGB/MS")
  parser.add_argument("data_dir", help="Ruta al directorio de datos (raz)")
...
--- [T=0.00s] ---
1. Ejecutando extraccin y split de datos (extract_data_to_img_for_train)
...
--- [T=55.20s] ---
1. Iniciando prediccin del modelo CNN...
5/5 -------------------- 1s 172ms/step
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/focal_loss/0.45\report_best_model_final_MULTIESPECTRAL_focal_loss.keras_20260325_1155_t45.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/focal_loss/0.45\report_best_model_final_MULTIESPECTRAL_focal_loss.keras_20260325_1155_t45_confusion.png
Matriz de confusin:
[[62 28]
 [ 4 39]]

--- RESUMEN DEL REPORTE DE CLASIFICACIN ---
              precision    recall  f1-score   support
...
#### 1.3 Resultados:
##### 1.3.1 Reporte de clasificacin json:
...
##### 1.3.2 Reporte de clasificacin tabla

# Reporte de Clasificacin - best_model_final_MULTIESPECTRAL_focal_loss.keras

- **Fecha:** 2026-03-25 11:55:39
- **Modelo:** best_model_final_MULTIESPECTRAL_focal_loss.keras
- **Umbral de decisin:** 0.45
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/focal_loss/0.5214\report_best_model_final_MULTIESPECTRAL_focal_loss.keras_20260325_1157_t52.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/focal_loss/0.5214\report_best_model_final_MULTIESPECTRAL_focal_loss.keras_20260325_1157_t52_confusion.png
Matriz de confusin:
[[64 26]
 [ 5 38]]
...
#### 2.3 Resultados:
##### 2.3.1 Reporte de clasificacin json:
````json
{
    "Plaga": {
...
##### 2.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - best_model_final_MULTIESPECTRAL_focal_loss.keras

- **Fecha:** 2026-03-25 11:57:24
- **Modelo:** best_model_final_MULTIESPECTRAL_focal_loss.keras
- **Umbral de decisin:** 0.5214
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/focal_loss/0.7\report_best_model_final_MULTIESPECTRAL_focal_loss.keras_20260325_1159_t70.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/focal_loss/0.7\report_best_model_final_MULTIESPECTRAL_focal_loss.keras_20260325_1159_t70_confusion.png
Matriz de confusin:
[[80 10]
 [15 28]]
...
#### 3.3 Resultados:
##### 3.3.1 Reporte de clasificacin json:
````json
{
    "Plaga": {
...
##### 3.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - best_model_final_MULTIESPECTRAL_focal_loss.keras

- **Fecha:** 2026-03-25 11:59:29
- **Modelo:** best_model_final_MULTIESPECTRAL_focal_loss.keras
- **Umbral de decisin:** 0.7
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/binary_crossentropy/0.45\report_best_model_final_MULTIESPECTRAL_binary_crossentropy.keras_20260325_1137_t45.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/binary_crossentropy/0.45\report_best_model_final_MULTIESPECTRAL_binary_crossentropy.keras_20260325_1137_t45_confusion.png
Matriz de confusin:
[[90  0]
 [42  1]]
...
##### 1.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - best_model_final_MULTIESPECTRAL_binary_crossentropy.keras
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/binary_crossentropy/0.5\report_best_model_final_MULTIESPECTRAL_binary_crossentropy.keras_20260325_1152_t50.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/binary_crossentropy/0.5\report_best_model_final_MULTIESPECTRAL_binary_crossentropy.keras_20260325_1152_t50_confusion.png
Matriz de confusin:
[[90  0]
 [42  1]]
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/binary_crossentropy/0.7\report_best_model_final_MULTIESPECTRAL_binary_crossentropy.keras_20260325_1154_t70.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/MULTIESPECTRAL/binary_crossentropy/0.7\report_best_model_final_MULTIESPECTRAL_binary_crossentropy.keras_20260325_1154_t70_confusion.png
Matriz de confusin:
[[90  0]
 [43  0]]
...
Forma X_train: (504, 224, 224, 3)
Forma Y_train: (504,)
Distribucin y_val: {np.int64(0): np.int64(83), np.int64(1): np.int64(43)}
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/focal_loss/0.45\report_best_model_final_RGB_focal_loss.keras_20260325_1425_t45.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/focal_loss/0.45\report_best_model_final_RGB_focal_loss.keras_20260325_1425_t45_confusion.png
Matriz de confusin:
[[ 0 83]
 [ 0 43]]
...
##### 1.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - best_model_final_RGB_focal_loss.keras
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/focal_loss/0.5214\report_best_model_final_RGB_focal_loss.keras_20260325_1441_t52.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/focal_loss/0.5214\report_best_model_final_RGB_focal_loss.keras_20260325_1441_t52_confusion.png
Matriz de confusin:
[[83  0]
 [43  0]]
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/focal_loss/0.7\report_best_model_final_RGB_focal_loss.keras_20260325_1444_t70.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/focal_loss/0.7\report_best_model_final_RGB_focal_loss.keras_20260325_1444_t70_confusion.png
Matriz de confusin:
[[83  0]
 [43  0]]
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/binary_crossentropy/0.45\report_best_model_final_RGB_binary_crossentropy.keras_20260325_1504_t45.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/binary_crossentropy/0.45\report_best_model_final_RGB_binary_crossentropy.keras_20260325_1504_t45_confusion.png
Matriz de confusin:
[[ 0 83]
 [ 0 43]]
...
##### 1.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - best_model_final_RGB_binary_crossentropy.keras
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/binary_crossentropy/0.5214\report_best_model_final_RGB_binary_crossentropy.keras_20260325_1508_t52.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/binary_crossentropy/0.5214\report_best_model_final_RGB_binary_crossentropy.keras_20260325_1508_t52_confusion.png
Matriz de confusin:
[[83  0]
 [43  0]]
...
4. Generando mtricas...
 ...
 Reporte de Clasificacin guardado en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/binary_crossentropy/0.7\report_best_model_final_RGB_binary_crossentropy.keras_20260325_1509_t70.json
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/CNN/RGB/binary_crossentropy/0.7\report_best_model_final_RGB_binary_crossentropy.keras_20260325_1509_t70_confusion.png
Matriz de confusin:
[[83  0]
 [43  0]]
...
Forma X_train: (532, 224, 224, 5)
Forma Y_train: (532,)
Distribucin y_val: {np.int64(0): np.int64(90), np.int64(1): np.int64(43)}
...
STD: 0.3479576397721457
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/RF_MULTIESPECTRAL\cm_RF_MULTIESPECTRAL_20260325_1614.png
Matriz de confusin:
[[67 23]
 [13 30]]
...
##### 1.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - RANDOM_FOREST_MULTIESPECTRAL_20260325_1625

- **Fecha:** 2026-03-25 16:27:04
- **Modelo:** RANDOM_FOREST_MULTIESPECTRAL_20260325_1625
- **Umbral de decisin:** por defecto 0.5
...
MAX: 1.0
STD: 0.3479576397721457
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/RANDOM_FOREST/MULTIESPECTRAL/0.5214\report_best_model_RANDOM_FOREST_MULTIESPECTRAL_20260325_1630.png
Matriz de confusin:
[[70 20]
 [16 27]]
...
--- [T=68.81s] ---
4. Evaluacin y Reporte de Random Forest...
...
##### 2.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - RANDOM_FOREST_MULTIESPECTRAL_20260325_1630
...
MAX: 1.0
STD: 0.3479576397721457
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/RANDOM_FOREST/MULTIESPECTRAL/0.7\report_best_model_RANDOM_FOREST_MULTIESPECTRAL_20260325_1632.png
Matriz de confusin:
[[79 11]
 [25 18]]
...
##### 3.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - RANDOM_FOREST_MULTIESPECTRAL_20260325_1632
...
STD: 0.3760748937006677
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/RANDOM_FOREST/RGB/0.45\report_best_model_RANDOM_FOREST_RGB_20260325_1638.png
Matriz de confusin:
[[69 14]
 [ 6 37]]
...
##### 1.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - RANDOM_FOREST_RGB_20260325_1638
...
MAX: 1.0
STD: 0.3760748937006677
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/RANDOM_FOREST/RGB/0.5214\report_best_model_RANDOM_FOREST_RGB_20260325_1641.png
Matriz de confusin:
[[70 13]
 [ 9 34]]
...
##### 2.3.2 Reporte de clasificacin tabla
# Reporte de Clasificacin - RANDOM_FOREST_RGB_20260325_1641
...
MAX: 1.0
STD: 0.3760748937006677
 Matriz de Confusin guardada en: C:\workspace\hd-image-pest-detection-cnn-and-rf\src\pest_detection_models\evaluation_results/RANDOM_FOREST/RGB/0.7\report_best_model_RANDOM_FOREST_RGB_20260325_1642.png
Matriz de confusin:
[[77  6]
 [17 26]]

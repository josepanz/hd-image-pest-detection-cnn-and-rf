...
# ==== FOLDER structure ====
The data structure is schematically visualized below. It contains a metadafile and it has a folder for every study (TADDA_NARO_2021, TADDA_NARO_2022, ... etc). Every study has a field number (F1) with drone_data, measurements and plot_data. 
```bash

MIAPPE_Minimal_Spreadsheet_Template_TTADDAv4.xlsx
TTADDA_DRONE_01/
├── TTADDA_NARO_2021/            #studyId
├── TTADDA_NARO_2021_F1/ # field number, currently only one field
│   │   ├── drone_data/                   # RGB, DEM and multispectral orthomosaics
│   │   │   ├── 2021-05-18/                  # folder
│   │   │   │  ├── 20210518_rgb.tif      # orthomosaic RGB
│   │   │   │  ├── 20210518_dsm.tif    # elevation map
│   │   │   │  ├── 20210518_blue.tif    # blue channel multispectral data
│   │   │   │  ├── 20210518_green.tif  # green channel multispectral data
│   │   │   │  ├── 20210518_red.tif      # red channel multispectral data
│   │   │   │  ├── 20210518_red edge.tif     # red edge channel multispectral data
│   │   │   │  ├── 20210518_nir.tif     # near infrared channel multispectral data
│   │   │   ├── …/                   
│   │   │   ├── 2021-09-28/                   # folder
│   │   ├── measurements/                          # all ground truth data  / measurements
│   │   │  ├── NARO_field_2021_GT_additional.csv
│   │   │  ├── NARO_field_2021_GT_growthphases.csv
│   │   │  ├── NARO_field_2021_GT_yield.csv
│   │   │  ├── NARO_field_2021_GT_weather.csv
│   │   │  ├── NARO_field_2021_GT_weather_online.csv

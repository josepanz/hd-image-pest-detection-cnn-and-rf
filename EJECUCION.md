...
Ambos fixes de extracción de datos están en `pest_detection/datasets/extract_data_to_img.py`, que es idéntico en `master` y en las dos ramas de trabajo — el bug existía en las 3 por igual hasta esta corrección.
